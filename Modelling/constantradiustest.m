...
% Extensions to add: Aerodynamic force
...
if dor == "0"
    ...
    thet_start = pi/2 + 0.4186632; % rad - start angle [0.4186632]
    thet_end = pi/2 + 2.6203882; % rad - finish angle [2.6203882]
    
    m_d = 1;
    
elseif dor == "1"
    
    thet_end = pi/2 + 0.4186632; % rad - start angle [0.4186632]
    thet_start = pi/2 + 2.6203882; % rad - finish angle [2.6203882]
    m_d = -1;
...
ylabel('Speed [rad/s]')
legend(num2str(G_r(1)))
saveas(gcf, 'Torque Speed Curve.png')
